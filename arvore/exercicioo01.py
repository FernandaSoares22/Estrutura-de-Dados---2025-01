# 1. Implemente uma estrutura de dados que represente uma árvore binária de busca, contendo, no mínimo, as seguintes funcionalidades:
# Criação da estrutura da árvore;
# Inserção de novos elementos;
# Impressão da árvore usando:
# Percurso em pré-ordem
# Percurso em pós-ordem
# Percurso em ordem simétrica
# Remoção (deleção) de elementos da árvore;Busca de elementos.
